...
class FilterSection extends Component {
  ...
  appliedFilters() {
    ...
    return filterString.length > maxStringLength
  ...
  render() {
    ...
    return (
      <div className="vw__filter-section">
        ...
        <button
          className={cx('filter-accordion', { 'is-open': isOpen })}
          onClick={this.toggle}
        >
          <div className="grid-container">
            ...
            <div className="filter-actions">
              <div className="filtered-choices">{this.appliedFilters()}</div>
        ...
        {isOpen && (
          <div className={cx('section-content', { 'has-swatch': attributes.length > 80 })}>
            {attributes.map((attribute) => (
              <FilterAttribute
                key={attribute.value}
                isSwatch={attributes.length > 80}
                selected={this.isSelected(attribute)}
                attribute={attribute}
